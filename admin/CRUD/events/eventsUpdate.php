...
$sql = "SELECT events_cat.category_name, events.event_title, events.event_description, events.event_icon, events.event_date, events.event_start_time, events.event_end_time, events.event_location, events_cat.category_name 
...
$event_icon = $_FILES["inputEventIconEdit"]["name"];
...
SET event_title=?, event_description=?, event_icon=?, event_date=?, event_start_time=?, event_end_time=?, event_location=?, event_category_category_id=?
WHERE id='$id'";
$result = $conn->prepare($updateSQL);
$runQuery = $result->execute([$event_title, $event_description, $event_icon, $event_date, $event_start_time, $event_end_time, $event_location, $event_category]);
if($runQuery){
