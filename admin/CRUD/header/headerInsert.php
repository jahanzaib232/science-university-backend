...
if(isset($_POST['submitBtn'])){
    ...
    $sql = $conn->prepare("INSERT INTO db_science_university_header (image_path_file, header_title, header_text, order_, db_science_university_users_id) VALUES (?, ?, ?, ?, ?)");
    $sql->execute([$header_image, $header_title, $header_text, $header_order, $userID]);
    if($runQuery){     
